...
class FileCoreSettingsRepositoryTest {
    ...
    fun `validateSettings single argument overload`() {
        DefaultCoreSettingsValidator().validateSettings(validSettings)
    }
    ...
    fun `save with null parent path`() {
        ...
        every {
            Files.move(mockTempFile, mockPath, java.nio.file.StandardCopyOption.REPLACE_EXISTING, java.nio.file.StandardCopyOption.ATOMIC_MOVE)
        } returns mockPath
