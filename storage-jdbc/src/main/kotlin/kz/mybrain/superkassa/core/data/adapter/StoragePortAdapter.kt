 ...
 * Делегирует выполнение специализированным классам-делегатам для соблюдения лимита на размер классов.
 */
class StoragePortAdapter(
    ...
    // Queue
    override fun enqueueQueueTask(dto: QueueTaskDto): Boolean = withSession { queueDelegate.enqueueQueueTask(dto) }
    override fun listQueueTasksByCashbox(cashboxId: String, lane: String, limit: Int, offset: Int): List<QueueTaskDto> =
