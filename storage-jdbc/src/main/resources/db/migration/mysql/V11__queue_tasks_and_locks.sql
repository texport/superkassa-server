...
CREATE INDEX idx_queue_task_cashbox_lane_status
    ON queue_task (cashbox_id, lane, status, created_at);

CREATE INDEX idx_queue_task_next_attempt
    ON queue_task (next_attempt_at);
...
CREATE INDEX idx_queue_lock_lease_until
