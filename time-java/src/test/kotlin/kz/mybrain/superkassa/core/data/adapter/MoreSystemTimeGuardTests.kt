...
class MoreSystemTimeGuardTests {
    ...
    fun `validate monotonic check handles system clock drift backwards`() {
        ...
        // Monotonic time advanced normally by 1 second, but wall clock is set to now - 180000 (drifted backward)
